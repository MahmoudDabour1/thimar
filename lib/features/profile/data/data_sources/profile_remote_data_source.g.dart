...
class _ProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  Future<UpdateProfileDataResponseModel> updateProfileData(
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<UpdateProfileDataResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateProfileDataResponseModel _value;
    try {
      _value = UpdateProfileDataResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
