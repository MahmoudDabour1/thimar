...
class _HomeRemoteDataSource implements HomeRemoteDataSource {
  ...
  Future<SliderResponseModel> getSliders() async {
    ...
    final _options = _setStreamType<SliderResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late SliderResponseModel _value;
    try {
      _value = SliderResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetCategoryProductsResponseModel> getCategoryProducts(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetCategoryProductsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetCategoryProductsResponseModel _value;
    try {
      _value = GetCategoryProductsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
