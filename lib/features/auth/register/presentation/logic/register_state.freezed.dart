...
mixin _$RegisterState<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(RegisterInitial<T> value) initial,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(RegisterInitial<T> value)? initial,
...
class _$RegisterSuccessImpl<T> implements RegisterSuccess<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.success(response: $response)';
  }
...
abstract class RegisterSuccess<T> implements RegisterState<T> {
  const factory RegisterSuccess(final T response) = _$RegisterSuccessImpl<T>;
