...
class _$ForgetPasswordSuccessImpl<T> implements ForgetPasswordSuccess<T> {
  const _$ForgetPasswordSuccessImpl(this.response);
  ...
  @override
  String toString() {
    return 'ForgetPasswordState<$T>.success(response: $response)';
  }
...
abstract class ForgetPasswordSuccess<T> implements ForgetPasswordState<T> {
  const factory ForgetPasswordSuccess(final T response) =
      _$ForgetPasswordSuccessImpl<T>;
